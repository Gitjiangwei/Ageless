    ...
    $.ajax({
        ...
        success:function(data){
            ...
            data.map(function(item,index){
                oneCategory +='<tr><td><input type="checkbox" name="box" id="id" value='+item.id+'><br />已 <br />上<br />架</td> <td>'+item.productName+'</td><td><img src="'+item.productPic.picPath+'" width="100" height="100"></td> <td>'+item.kucun+'</td> <td>'+item.xiaoliang+'</td> <td>'+item.update+'</td></tr>';
            });
            $("#yifen").html("");
